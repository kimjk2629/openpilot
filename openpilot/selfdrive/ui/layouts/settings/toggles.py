...
DESCRIPTIONS = {
  ...
  "DisableDM": tr_noop(
    "Turn off the driver monitoring camera and its attention alerts entirely. sunnypilot will no longer watch the driver facing camera, " +
    "so use this only if you understand the safety tradeoff."
  ),
